...
export class OfertaCardComponent {
  ...
  public authService = inject(AuthService); // Inyectar AuthService
  ...
  onImageError(event: any): void {
    ...
    event.target.src = 'https://placehold.co/400x300/e0e0e0/000000?text=No+Image';
    event.target.onerror = null; // Evitar bucle infinito si el placeholder también falla
  }
